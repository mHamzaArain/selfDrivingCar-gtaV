...
MODEL_NAME = 'Full-screen'
PREV_MODEL = 'Full-screen'
...
for e in range(EPOCHS):
    ...
    for count,i in enumerate(data_order):
        ...
        try:
            file_name = 'npy-fullScreen\\training_data-{}.npy'.format(i)
            # full file info
...
# tensorboard --logdir=foo:C:\Users\Hamza Arain\Desktop\v2\log